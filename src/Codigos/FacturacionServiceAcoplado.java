...
public class FacturacionServiceAcoplado {
    private ValidacionService validacionSevice;
    private CorreoSevice correoSevice;
    private PagoService pagoService;

    public FacturacionServiceAcoplado(ValidacionService validacionSevice, CorreoSevice correoSevice, PagoService pagoService) {
        super();
